...
[params, heap, next_item_idx, latest_idx] = init_heap_for_solver();
[heap, next_item_idx] = points_to_heap_var_sampling_rate(heap, latest_idx, next_item_idx, points, params);
