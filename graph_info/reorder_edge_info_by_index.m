...
edge_info.R_is_dummy = edge_info.R_is_dummy(reorder_idx);
edge_info.C_is_dummy = edge_info.C_is_dummy(reorder_idx);
edge_info.L_is_dummy = edge_info.L_is_dummy(reorder_idx);
...
edge_info.device_info = edge_info.device_info(reorder_idx);